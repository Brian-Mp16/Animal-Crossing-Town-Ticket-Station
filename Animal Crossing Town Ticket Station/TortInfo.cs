...
namespace Animal_Crossing_Town_Ticket_Station
{
    internal class TortInfo
    {
        ...
        public TortInfo(string article, string name, int index, int quantity, int?[,] monthArray, int?[,] hourArray, int?[,] weekdayArray, int?[,] weatherArray, int tickets, Image imageName)
        {
            Article = article;
            Name = name;
            Index = index;
